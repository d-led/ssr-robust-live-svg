defmodule SsrRobustLiveSvgWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(SsrRobustLiveSvgWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(SsrRobustLiveSvgWeb.Gettext, "errors", msg, opts)
    # end
