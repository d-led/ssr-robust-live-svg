defmodule BraitenbergVehiclesLiveWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(BraitenbergVehiclesLiveWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(BraitenbergVehiclesLiveWeb.Gettext, "errors", msg, opts)
    # end
