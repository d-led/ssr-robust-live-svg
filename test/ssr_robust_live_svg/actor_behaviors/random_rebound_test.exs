defmodule SsrRobustLiveSvg.RandomReboundTest do
  use ExUnit.Case

  # switch to this module to show the bug
  # @random_rebound_module SsrRobustLiveSvg.RandomRebound
  @random_rebound_module SsrRobustLiveSvg.RandomReboundV2NonSticky
